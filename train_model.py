...
if __name__ == "__main__":
    ...
    if data_load == "c":
        ...
        with h5py.File(Path(root_dir)/"results/data_train-xdat-o.h5", "w") as hf:
        ...
        with h5py.File(Path(root_dir)/"results/data_train-xdat-o.h5", "r") as hf:
    ...
    history = train_model("hold out", mname=Path(root_dir)/"results/CeO2_111_CO_xdat_o.h5", epochs=3)
