...
if __name__ == "__main__":
    ...
    Xinput_mo_dir = Path(Path(root_dir) / "train_set" / "xinput-test")
    Xoutput_mo_dir = Path(Path(root_dir) / "train_set" / "xoutput-test")
    ...
    for file in os.listdir(XDATCAR_dir):
        ...
        x.to_CONTCAR(dname=Xoutput_mo_dir, indexes=[-1])